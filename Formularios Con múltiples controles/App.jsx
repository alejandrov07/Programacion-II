...
function App() {
  ...
  return (
    <div className="contenedor">
      ...
      {/* Panel de valores en tiempo real: no depende de ningún botón,
          se re-renderiza solo porque comentario/categoria/calificacion
          cambiaron y React vuelve a dibujar el componente. */}
      <div className="resultado">
        <h2>Valores capturados en tiempo real:</h2>
        <p><strong>Comentario:</strong> {comentario}</p>
        <p><strong>Categoria:</strong> {categoria}</p>
        <p><strong>Calificacion:</strong> {calificacion}</p>
      </div>
    </div>
  )
}
